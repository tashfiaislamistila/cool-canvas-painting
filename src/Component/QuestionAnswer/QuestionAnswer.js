    ...
    return (
        <div className='qus-ans'>
            ...
            <p>Answer: React is a javascript library.For any other kind of library you can use
                it, import it and also use its method.React has virtual dom and it manipulates the browser dom.React simply compare the virtual dom to real
                dom.React is able to decide very quickly where it is changed in our markup.After that it renders the result very quickly in our screen.
            </p>
        </div>
    );
};
